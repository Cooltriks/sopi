...
function create_slider(el, settings, minSlides) {
	...
	if (el.children.length > 1) {
		//new_css('css-swiper', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-swiper.css?v=111603181540343972631684760419');
		...
		Default = {
			utils: {
								...
								if (el.tagName.toLowerCase() === 'a') {
									el.addEventListener('click', function (e) {
										if (html_tag.classList.contains('t1ac')) {
											...
											new_css('accessible-mode-css', "//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/theme-accessible.css?v=183390142599239287431684760420");
				...
				mobile: function () {
					...
					new_js("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/scripts-async.js?v=106134728460860833411692336263");
				},
				ratings: function () {
...
window.addEventListener("showAlert", function(event) {
	...
	if (list_alerts === null) {
		...
		if (document.getElementsByClassName('shopify-section-footer')[0]) {
			document.getElementsByClassName('shopify-section-footer')[0].parentNode.insertBefore(list_alerts, document.getElementsByClassName('shopify-section-footer')[0].nextSibling);
		} else {
