...
function nav_burger() {
	...
	if (html_tag.classList.contains('m2a')) {
		...
		new_css('css-menu', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-menu.css?v=110783649945792712261684760420');
	}
}
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async.css?v=52509283729687325021684760417');
}
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async.css?v=52509283729687325021684760417');
	new_css('hovers-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-hovers.css?v=79149632293301193081684760418');
}
if (!isMobile) {
...
function validate_me(el) {
	"use strict";
  loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-validator.js?v=4437891403865003331684760441", function () {
		...
		new_css('form-validation-css', "//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-validation.css?v=106201327838839730281684760418");
	}, 'validator-loaded');
...
window.addEventListener("dataChange", function (evt) {
	var data_change = document.querySelectorAll('a[data-change][title]:not(.listening), input[data-change][title]:not(.listening-data-change)'),
...
if (form_product_sticky.length) {
	Array.from(form_product_sticky).forEach(function (el) {
		...
		/*if(el.classList.contains('visible')){
			new_css('css-product-scrolled', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-product-scrolled.css?v=19869886983330127861684760420');
...
window.addEventListener("semanticSelect", function (evt) {
	...
	if (select_tag.length && !isMobile) {
		loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-selects.js?v=155503929527207815761684760420", function () {
			"use strict";
			Array.from(select_tag).forEach(function (el) {
				...
				if (!isMobile) {
					...
					Array.from(el.parentNode.getElementsByClassName('bv_atual')).forEach(function (em) {
						em.addEventListener('click', function () {
							new_css('css-select', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-select.css?v=116768044393015328621684760419');
						});
...
// new_css('css-panels', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-panels.css?v=142145762535685859901684760420');
...
window.addEventListener("imageCompare", function(evt) {
	...
	if (image_compare.length) {
		loadRes('//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-compare.js?v=108280108769912210341684760419', function () {
			"use strict";
			new_css('compare-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-compare.css?v=26780671106752519771684760417');
	...
	if (search_id) {
		...
		Array.from(search_input).forEach(function (el) {
			...
			el.addEventListener('focus', function () {
				...
				new_css('css-search', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-search.css?v=94727084399876925701684760420');
			});
		});
		...
		function clearCompactSearch() {
			"use strict";
			html_tag.classList.remove('search-compact-active', 'search-full', 'search-full-mode');
			search_id.classList.remove('full', 'has-text', 'not-empty');
			negTabIn(search_id.getElementsByTagName('fieldset')[0]);
			search_input[0].value = '';
...
window.addEventListener("schemeTooltip", function (evt) {
	...
	if (scheme_tooltip.length) {
		// new_css('css-tooltips', "//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-tooltips.css?537");
...
var loadPopup = function (id) {
	"use strict";
	loadRes('//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-popups.js?v=103284100310891270841684760441', function () {
		var allPopups = document.querySelectorAll('[class^="popup-"]:not(html):not(.ready)');
		Array.from(allPopups).forEach(function (el) {
			root_id.appendChild(el);
		});
...
window.addEventListener("rangeSlider", function(evt) {
	...
	if (input_range.length) {
		...
		loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-sliders.js?v=106367203436165194411684760417", function () {
			"use strict";
			new_css('form-sliders-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-ui-sliders.css?v=72896717569740218131684760418');
...
/*window.addEventListener("masonry", function(evt) {
	...
	if (list_featured.length) {
		loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-masonry.js?v=19905838331864423561684760419", function () {
			"use strict";
...
window.addEventListener("stickyNav", function(evt) {
	...
	if (top_bar) {
		...
		if (Cookies.get('notice', { sameSite: 'none', secure: true }) === 'closed') {
			...
			new_css('announcement-css', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-announcement.css?v=101086063507671232151684760418');
	...
	if (form_filter.length) {
		...
		Array.from(document.querySelectorAll('a[aria-controls="filter"]')).forEach(function (el) {
			...
			el.addEventListener('click', function (e) {
				...
				new_css('css-filters', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-filters.css?v=163087856744389031651684760420');
				e.preventDefault();
			});
		});
	}
...
window.addEventListener("countdown", function(evt) {
	...
	if (countdown_tag.length) {
		loadRes('//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-countdown.js?v=30852516867416231701684760420', function () {
			"use strict";
...
if (list_count.length) {
	loadRes('//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-countup.js?v=23403240054145588091684760419', function () {
		"use strict";
...
if (link_print.length) {
	Array.from(link_print).forEach(function (el) {
		"use strict";
		el.addEventListener('click', function (e) {
			new_css('css-print', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-print.css?v=98634256293469202081684760417');
			setTimeout(function () {
				window.print();
			}, 400);
			e.preventDefault();
	...
	if (data_fancybox.length) {
		Array.from(data_fancybox).forEach(function (el, index) {
			...
			el.addEventListener('click', function (e) {
				...
				loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-fancybox.js?v=53225757861153421831684760419", function () {
					new_css('css-fancybox', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-fancybox.css?v=57980775351751459211684760419');
...
window.addEventListener("hotspots", function (evt) {
	...
	if (list_hotspots.length) {
		new_css('css-hotspots', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-hotspots.css?v=80756921319098295931684760417');
...
window.addEventListener("maqruee", function (evt) {
	...
	if (module_maqruee.length) {
		loadRes("//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/plugin-typewritter.js?v=141057276794469966851684760420", function () {
			Array.from(module_maqruee).forEach(function (el) {
				...
				if (!el.classList.contains('type')) {
					...
					for (var i = 0; i < Math.ceil(root_id.clientWidth/ul.clientWidth) + 1; i++) {
		...
		new_css('css-marquee', '//cdn.shopify.com/s/files/1/0672/2741/8925/t/18/assets/async-marquee.css?v=149015968313448279071684760420');
	}
});
